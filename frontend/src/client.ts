// Code generated by the Encore v1.20.3 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-meeting-notes-8ami.encr.app`
}
...
/**
 * Client is an API client for the meeting-notes-8ami Encore application. 
 */
...
export namespace note {
    ...
    export class ServiceClient {
        ...
        public async Get(id: string): Promise<Note> {
            ...
            const resp = await this.baseClient.callAPI("GET", `/url/${encodeURIComponent(id)}`)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        this.headers = {
            ...
            "User-Agent":   "meeting-notes-8ami-Generated-TS-Client (Encore/v1.20.3)",
        }
